...
*Figure S2: Full NCI analysis of the perfume UGC street interview (35s). Highest Somatomotor activation (27%) of all five videos, reflecting strong embodied/sensory processing. Salience peaks are front-to-mid loaded (8s, 16s, 21s), indicating early and sustained engagement. Elevated Limbic activation (9%) compared to other talking-head content suggests emotional connection to the product.*
...
| **Elon AI** (Tech News) | 60s | Somatomotor 22% + Default Mode 19% + Frontoparietal 16% | 29s, 43s, 13s (distributed) | Information density, argument quality, critical engagement | Leverage high Frontoparietal for CTA placement; the 29s mid-video peak suggests a structural break point |
| **Perfume UGC** (Product Review) | 35s | Somatomotor 27% + Default Mode 16% | 16s, 21s, 8s (front-to-mid) | Embodied/sensory experience, authentic delivery | Highest Somatomotor = strongest embodied response; early peaks suggest strong opening engagement; optimize for sensory language |
...
**2. Hook timing varies by content type.** The opening-second hook dogma ("you must capture attention in the first second") does not apply uniformly across content types. The product demo and UGC perfume review show front-loaded salience peaks (7-10s and 8-16s respectively), while the viral ice cutter's strongest moments are distributed across mid-to-late sections (21s, 32s, 40s). The business education video shows distributed peaks throughout. Different formats have different temporal engagement signatures, and NCI reveals where each format's strongest moments actually are.
