...
**Salience peaks (hook moments):** 10s, 17s, 7s --- front-loaded, with the strongest moments in the first half of the demonstration.
...
|---|---|---|---|---|---|
| **Leila Hormozi** (Business Ed.) | 49s | Somatomotor 25% + Default Mode 18% | 30s, 14s, 19s (distributed) | Speaker delivery, argument structure, personal relevance | Optimize voice, cadence, facial expression; multiple hook moments available for re-editing |
| **Elon AI** (Tech News) | 60s | Somatomotor 22% + Default Mode 19% + Frontoparietal 16% | 29s, 7s, 43s (opening + distributed) | Information density, argument quality, critical engagement | Early hook at 7s grabs attention; the 29s mid-video peak suggests a structural break point; leverage high Frontoparietal for CTA placement |
| **Perfume UGC** (Product Review) | 35s | Somatomotor 27% + Default Mode 16% | 4s, 16s, 21s (opening hook + sustained) | Embodied/sensory experience, authentic delivery | Highest Somatomotor = strongest embodied response; strong 4s opening hook confirms the format grabs immediately; optimize for sensory language |
| **Sanitary Pad** (Product Demo) | 25s | Dorsal Attention 32% + Visual 31% | 10s, 17s, 7s (front-loaded) | Visual clarity, demonstration pacing, proof moments | Pure "show don't tell"; early salience peaks suggest viewers engage most with initial demonstration setup |
| **Ice Cutter** (Viral Satisfying) | 48s | Visual 28% + Dorsal Attention 27% + Ventral Attention 17% | 21s, 40s, 32s (mid-to-late) | Visual rhythm, surprise timing, reveal pacing | Optimize salience-peak frequency; content sustains engagement through well-spaced payoff moments |
